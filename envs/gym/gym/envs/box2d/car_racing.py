...
from gym.envs.box2d.parking_garage.race_car import RaceCar
from typing import Any, Dict, List, Optional, Tuple, Type, Union
from gym.envs.box2d.parking_garage.bus import AWDBus  # as Car
from gym.envs.box2d.parking_garage.bus import AWDBusLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.bus import AWDBusSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.bus import Bus  # as Car
from gym.envs.box2d.parking_garage.bus import BusLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.bus import BusSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.bus import FWDBus  # as Car
from gym.envs.box2d.parking_garage.bus import FWDBusLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.bus import FWDBusSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import AWDRaceCar  # as Car
from gym.envs.box2d.parking_garage.race_car import AWDRaceCarLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import AWDRaceCarSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import FWDRaceCar  # as Car
from gym.envs.box2d.parking_garage.race_car import FWDRaceCarLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import FWDRaceCarSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import RaceCarLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import RaceCarSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.race_car import RaceCar
from gym.envs.box2d.parking_garage.street_car import AWDStreetCar  # as Car
from gym.envs.box2d.parking_garage.street_car import AWDStreetCarLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.street_car import AWDStreetCarSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.street_car import FWDStreetCar  # as Car
from gym.envs.box2d.parking_garage.street_car import FWDStreetCarLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.street_car import FWDStreetCarSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.street_car import StreetCar  # as Car
from gym.envs.box2d.parking_garage.street_car import StreetCarLargeTrailer  # as Car
from gym.envs.box2d.parking_garage.street_car import StreetCarSmallTrailer  # as Car
from gym.envs.box2d.parking_garage.trike import TukTuk  # as Car
from gym.envs.box2d.parking_garage.trike import TukTukSmallTrailer  # as Car
...
TRACK_TURN_RATE = 0.31 # larger -> sharper turn
...
class CarRacing(gym.Env, EzPickle):
    ...
    def __init__(self, contexts=None, verbose=0):
    ...
    def _create_track(self):
        # CHECKPOINTS = 16 # larger -> sharper turn # less_sharp
        # CHECKPOINTS = 18 # larger -> sharper turn # less_sharp_2
        # CHECKPOINTS = 22 # larger -> sharper turn # sharp_3
        CHECKPOINTS = 12 # larger -> sharper turn # sharp_4
    ...
    def set_context_dist(self, context_dist):
        assert len(context_dist) == len(self.contexts)
        self.context_dist = context_dist
    
    def _sample_context(self):
        car_index = self.np_random.choice(len(self.context_dist), p=self.context_dist)
        self.context = car_index
        # self.context = 14

    def _update_context(self) -> None:
        self.vehicle_class = PARKING_GARAGE[self.context]
    ...
    def reset(self) -> np.ndarray:
        ...
        # idx = self.np_random.choice(len(self.track))
    ...
    def step(self, action):
        ...
        # add np.copy
        return deepcopy(self.state), step_reward, done, {}
